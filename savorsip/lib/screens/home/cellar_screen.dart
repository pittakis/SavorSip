...
import 'package:savorsip/components/wine_card_home.dart';
...
class _CellarScreenState extends State<CellarScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const Text(
            'Swipe right for the leaderboard',
            ...
            child: FutureBuilder<List<Rating>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  snapshot.data!
                      .sort((a, b) => b.ratingTime.compareTo(a.ratingTime));
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return FutureBuilder<Users>(
                          future:
                              Users.fetchUserData(leaderboardEntry['userId']),
                          builder: (context, userSnapshot) {
                            if (userSnapshot.connectionState ==
                              ...
                              return _generateFriendTile(userSnapshot.data!,
                                  index, leaderboardEntry['numberOfRating']);
                            }
                          },
                        );
                      },
  ...
  Widget _generateFriendTile(Users userFriend, int index, int numberOfRatings) {
    ...
    switch (index) {
      ...
      case 1:
        textColor =
            const Color(0xFFC0C0C0); // Silver color for the second place
        break;
      case 2:
